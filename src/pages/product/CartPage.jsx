...
const CartPage = () => {
  ...
  return (
    <div className="flex flex-col gap-9 px-56 bg-gray-50">
      <div>
        <h1 className="font-semibold text-2xl">Keranjang Belanja (1 item)</h1>
      </div>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[2fr_1fr]">
                  ...
                  <div className="flex flex-1 flex-col">
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500">Hitam</p>
                      </div>
          ...
          <div className="h-fit rounded-2xl border border-gray-200 bg-white p-6">
            ...
            <button
              ...
              className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl bg-orange-500 py-4 font-medium text-white transition hover:bg-orange-600">
              <Shield size={18} />
              Checkout Aman
            </button>
